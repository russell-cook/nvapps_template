...
namespace NVApps.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    // if no returnUrl is specified, send user to TrafficController, which re-driects to user's default module
                    // default module is determined by ApplicationUser.AppModuleID value (default is 1 for Manage User Account page)
                    if (returnUrl != null)
                    {
                    ...
                    {
                        return RedirectToAction("DefaultModule", "Traffic");
                    }
        ...
        public async Task<ActionResult> ConfirmEmail(string userId, string code)
        {
            ...
            return View(result.Succeeded ? "ConfirmEmail" : "ConfirmEmailTokenExpirationError");
        }
